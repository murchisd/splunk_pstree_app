...
# pstree logic adapted from 
# Iterative Preorder Traversal of an N-ary Tree
# https://www.geeksforgeeks.org/iterative-preorder-traversal-of-a-n-ary-tree/#:~:text=Preorder%20Traversal%20of%20an%20N%2Dary%20Tree%20is%20similar%20to,Preorder%20Traversal%20of%20Binary%20Tree.
...
@Configuration()
class PSTreeCommand_V2(EventingCommand):
        ...
        **Description:** Name of the field that holds detail value for child field''',
        ...
        def transform(self, records):
                ...
                self.logger.error("PSTREE %s",tree)
                for parent in tree:
...
dispatch(PSTreeCommand_V2, sys.argv, sys.stdin, sys.stdout, __name__)
